...
const Projects = (props) => {
    ...
    const clickModalXHandler = (title) => {
        modal = document.getElementById(title.split(' ').join('-'))
        console.log(modal)
    ...
    const projectModalsObjects = [
        {
            ...
            'clickModalXHandler': clickModalXHandler('Hot Doggity Dog Walkers')
        },
        {
            ...
            'clickModalXHandler': clickModalXHandler('Alien Invaders')
        },
        {
            ...
            'clickModalXHandler': clickModalXHandler('Simple JWT Authentication Proof-Of-Concept')
        }
