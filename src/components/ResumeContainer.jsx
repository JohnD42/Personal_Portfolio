    ...
    return (
        <div id="accordion-collapse-resume" data-accordion="collapse" className='flex flex-col items-center justify-center mb-16'>
            <h2 id="accordion-collapse-heading">
                <button type="button" className={`flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 ${ store.darkMode ? 'focus:ring-gray-700 border-gray-600 hover:bg-gray-300 bg-gray-800' : 'border-gray-100 focus:ring-gray-200 hover:bg-gray-50 bg-gray-300'} rounded-t-xl focus:ring-4 gap-3`} data-accordion-target="#accordion-collapse-body-1" aria-expanded="false" aria-controls="accordion-collapse-body-1">
                <span>Resume</span>
